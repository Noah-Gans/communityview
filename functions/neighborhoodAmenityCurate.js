...
async function callGeminiCurate(payload) {
  ...
  const prompt = [
    ...
    "INCLUDE: well-known restaurants, cafes, grocery, parks, fitness, transit hubs, everyday essentials.",
    ...
    "(Dining, Coffee, Grocery, Fitness, Parks, Transit, Essentials) when available.",
    ...densityLines,
