...
export const TOUR_NEARBY_DATA_VERSION = 26;
...
/** Include unrated POIs after rated picks (parks often lack Google ratings). */
 ...
 * @param {unknown[]} features
 * @param {{ amenityKey?: string, maxResults?: number }} [options]
 */
